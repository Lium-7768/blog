-- ============================================
-- Blog Database Schema - Full Migration
...
create policy if not exists "Authors can view their own posts"
...
create policy if not exists "Users can view their own comments"
...
create policy if not exists "Post tags are viewable by everyone"
  on post_tags for select using (true);

create policy if not exists "Authors can manage post tags"
...
-- 10. Create trigger for posts
drop trigger if exists update_posts_updated_at on posts;
create trigger update_posts_updated_at
  before update on posts
  for each row execute function update_updated_at_column();

-- 11. Create function for profile on signup
...
-- 13. Create function to get posts by tag
...
-- 14. Create function to increment post views
